<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=200&section=header&text=Balirwa%20Alvin%20Daniel&fontSize=50&fontColor=fff&animation=twinkling&fontAlignY=38&desc=Full-Stack%20Developer%20%7C%20Uganda%20🇺🇬&descAlignY=58&descSize=18" width="100%" />
...
> *"Clean code, scalable systems, and impactful products — that's what I build."*
...
<div align="center">
  ...
  [![GitHub Contributor Stats](https://github-contributor-stats.vercel.app/api?username=balirwaalvin&limit=5&theme=dark&combine_all_yearly_contributions=true)](https://github.com/gayanvoice/top-github-users/blob/main/markdown/total_contributions/uganda.md)

  <a href="https://github.com/gayanvoice/top-github-users/blob/main/markdown/total_contributions/uganda.md">
    <img src="https://img.shields.io/badge/🇺🇬%20Uganda%20GitHub%20Ranking-View%20on%20Top%20GitHub%20Users-2E9EF7?style=for-the-badge" alt="Uganda GitHub Ranking" />
  </a>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>🏥 <a href="https://github.com/balirwaalvin/NutriCan-Mobile">NutriCan Mobile</a></h3>
      <p>A compassionate mobile health application for cancer patients, providing AI-powered personalised nutrition guidance and wellness support throughout their treatment journey.</p>
      <ul>
        <li>🍽️ AI-powered personalised meal plans by cancer type & stage</li>
        <li>🔍 Food safety checker for treatment-safe foods</li>
        <li>📊 Nutrient tracking with visual charts & insights</li>
        <li>💊 Symptom-based nutrition tips</li>
        <li>📝 Progress journal for wellness tracking</li>
      </ul>
      <p>
    ...
    <td width="50%" valign="top">
      <h3>💊 <a href="https://github.com/balirwaalvin/PharmaX">PharmaX — Online Pharmacy</a></h3>
      <p>A comprehensive web-based pharmacy management system with separate interfaces for customers, managers, and administrators. Features secure role-based access control and Docker support.</p>
      <ul>
        <li>🛒 Customer portal for browsing & ordering products</li>
        <li>📦 Manager dashboard for inventory management</li>
        <li>👥 Admin panel for system administration</li>
        <li>🔐 Secure authentication & role-based access control</li>
        <li>🐳 Docker containerisation support</li>
      </ul>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      <h3>📱 <a href="https://github.com/balirwaalvin/QR-Attendance-System">QR Attendance System</a></h3>
      <p>An innovative contactless attendance tracking system leveraging QR code technology for efficient, real-time attendance management.</p>
      <ul>
    ...
    <td width="50%" valign="top">
      <h3>🐍 <a href="https://github.com/balirwaalvin/Python---Programming">Python Programming Guide</a></h3>
      <p>An all-in-one learning resource for mastering Python, covering core language concepts, the Django framework, and practical real-world examples.</p>
      <ul>
        <li>🐍 Complete Python language coverage</li>
        <li>🌐 Django framework tutorials & examples</li>
        <li>📖 Module-based progressive learning</li>
        <li>💡 Clear, practical, runnable examples</li>
      </ul>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      <h3>⚛️ <a href="https://github.com/balirwaalvin/REACT--REPO">React + TypeScript Patterns</a></h3>
      <p>A curated collection of React + TypeScript design patterns, best practices, and real-world examples — a go-to reference for modern front-end development.</p>
      <ul>
        <li>🛠️ Real-world patterns and use cases</li>
        <li>📚 Comprehensive inline documentation</li>
        <li>✅ TypeScript-first approach throughout</li>
      </ul>
      <p>
        <img src="https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black" />
        <img src="https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white" />
    ...
    <td width="50%" valign="top">
      ...
      <p>Explore all of my open-source projects, learning resources, and experimental work.</p>
      <br/>
      <p align="center">
        <a href="https://github.com/balirwaalvin?tab=repositories">
