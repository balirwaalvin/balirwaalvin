...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>A compassionate AI-powered mobile health app for cancer patients, delivering personalised nutrition guidance and wellness support throughout treatment.</p>
      <ul>
        <li>🍽️ AI meal plans tailored by cancer type & stage</li>
        <li>🔍 Food safety checker for treatment-safe foods</li>
        <li>📊 Nutrient tracking with visual charts</li>
        <li>💊 Symptom-based nutrition tips</li>
        <li>📝 Wellness progress journal</li>
      </ul>
      <p>
    ...
    <td width="50%" valign="top">
      <h3>💊 <a href="https://github.com/balirwaalvin/PharmaX">PharmaX — Online Pharmacy Portal</a></h3>
      <p>A comprehensive web-based pharmacy management system with role-based portals for customers, managers, and administrators, featuring full inventory control.</p>
      <ul>
        <li>🛒 Customer portal for browsing & ordering</li>
        <li>📦 Manager dashboard for inventory control</li>
        <li>👥 Admin panel for system administration</li>
        <li>🔐 Secure role-based access control</li>
        <li>🐳 Full Docker containerisation</li>
      </ul>
      <p>
